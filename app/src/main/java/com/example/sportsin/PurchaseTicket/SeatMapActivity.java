...
public class SeatMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(SeatMapActivity.this);
        ...
        recyclerAdapter = new TicketRecyclerModel(SeatMapActivity.this,list);
