...
public class TicketRecyclerModel extends RecyclerView.Adapter<TicketRecyclerModel.ViewHolder> {
    ...
    public TicketRecyclerModel(Context context, ArrayList<HomeDataModel> list){
        this.list = list;
