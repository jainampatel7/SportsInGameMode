...
public class MerchandiseDataModel {
    private String merch_name;
    private String merch_size;
    private String merch_price;
    private String merch_image;

    public MerchandiseDataModel(String merch_name, String merch_size, String merch_price, String merch_image) {
